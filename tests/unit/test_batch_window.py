...
contradicting the "single-request TTFT barely affected" comment. W977 also breaks when the
...
overhead measured in W976 is NOT the batch window (proven: YUNSHU_BATCH_WAIT_MS=0 gave 70 vs
