"""W918: multi-prompt prompt_tokens failure-robustness.

W918: completions multi-prompt prompt_tokens summed by arithmetic stride
...
(The W921 tenant TPM settle tests have been removed along with the multi-tenant
...
def test_w918_completions_dedups_prompt_tokens_by_index():
...
def test_w918_dedup_logic_survives_partial_failure():
