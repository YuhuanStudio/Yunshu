...
class TestRadixNode:
    ...
    def test_path_blocks(self):
        ...
        assert [b.block_id for b in blocks] == [1, 0, 2]  # reversed from leaf->root then reverse
...
class TestRadixTree:
    ...
    def test_evict(self):
        ...
        leaf_a = t.insert([1, 2], [b0], [0xA1])
        leaf_b = t.insert([3, 4], [b1], [0xB1])
...
class TestRadixNodeSplitting:
    ...
    def test_split_on_partial_match(self):
        ...
        t = RadixTree()
        b0 = KVBlock(block_id=0)
        original = t.insert([1, 2, 3], [b0], [0xAAA])
    ...
    def test_try_merge_single_child(self):
        ...
        inner = t.insert([1, 2, 3], [KVBlock(block_id=0)], [0xAAA])
