...
scoring endpoints sanitized their scalar scores (W812) but /v1/pooling shipped vectors
...
def test_w959_pooling_has_finite_guard_like_siblings():
...
def test_w959_jsonresponse_rejects_nan_proving_the_bug():
