...
1. Request cancellation propagation through scheduler (SGLang pattern)
...
2. Chunked prefill progress reporting (vLLM pattern)
...
from yunshu_engine.scheduler import Scheduler, SchedulerConfig, SchedulerOutput
