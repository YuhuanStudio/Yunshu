...
from yunshu_kv.serialization import KVCacheSerializer, MAGIC, VERSION
...
class TestSerializeTable:
    def test_round_trip_basic(self):
        ...
        for orig, rest in zip(table.get_blocks(), restored_table.get_blocks()):
...
class TestFileIO:
    def test_save_load_round_trip(self):
        ...
        try:
            ...
            for orig, rest in zip(table.get_blocks(), rt_table.get_blocks()):
                np.testing.assert_array_equal(
