...
class TestStats:
    def test_get_stats_structure(self):
        ...
        for stage_val, stage_stats in stats.items():
...
class TestModelPreprocessorRegistry:
    def test_register_and_get(self):
        ...
        proc = lambda inputs, config: {"result": True}
    ...
    def test_register_custom_family_no_detection(self):
        ...
        reg = ModelPreprocessorRegistry()
        custom_proc = lambda inputs, config: {"custom": True}
        fallback_proc = lambda inputs, config: {"fallback": True}
    ...
    def test_fallback(self):
        reg = ModelPreprocessorRegistry()
        fallback = lambda inputs, config: {"fallback": True}
