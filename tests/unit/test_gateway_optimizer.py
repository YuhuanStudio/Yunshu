...
class TestRequestCoalescer:
    ...
    def test_add_request_returns_future(self):
        ...
        future = asyncio.new_event_loop().run_until_complete(c.add_request(req))
...
class TestResponseCache:
    ...
    def test_hash_request_distinguishes_output_affecting_params(self):
        """logprobs / logit_bias / xtc must change the key :
        a logprobs request must not collide with a plain one and get served a
