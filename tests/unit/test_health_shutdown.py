...
class TestHealthChecks:
    ...
    def test_readiness_probe_with_model(self):
        from yunshu_gateway.engine import get_engine, set_engine
        from yunshu_gateway.main import create_app
    ...
    def test_readiness_probe_no_model(self):
        ...
        resp = client.get("/health/ready")
        # a not-ready readiness probe must return HTTP 503 (LBs key off the
        # status code, not the body) — was 200 with ready=False (lying probe).
