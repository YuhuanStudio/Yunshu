...
> 審計日期: 2026-05-12 (最後更新: 2026-05-21 — Waves 282–308: 25 waves, 502+ bugs fixed. Latest: Wave 308 — 6 parallel agents: context window truncation for fast paths, per-request NgramProposer instances, abort zero-token accounting, Anthropic reasoning_tokens + stop-in-tools fix, SSD flush_pending_io thread safety, SuffixProposer accept bonus_token, WebUI TypeScript fixes, 11 files, 6744 tests.)
