...
> 審計日期: 2026-05-12 (最後更新: 2026-05-21 — Waves 282–306: 23 waves, 450+ bugs fixed. Latest: Wave 306 — RBAC can_infer authorization (5 routers), ConstrainedSampler EOS text corruption, BitmaskConstrainedSampler forced EOS advance, _get_type_from_schema mutation, LCGHashPool _indexed_len init, NgramSpecProposer.begin() reset, SuffixProposer bonus_token, Anthropic grammar parameter. 6744 tests pass.)
