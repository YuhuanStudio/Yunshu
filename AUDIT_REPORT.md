...
| N-gram speculative decoding | 無需 draft model 的投機解碼，純 CPU N-gram 匹配 | ✓ |
...
| 無 hash-based block dedup + COW | vLLM | 高 | ✅ Wave 21 (block refcounting + COW snapshot) |
| 無 SSD-tier KV cache | oMLX | 中 | ✅ Wave 21 (SSDKVCache + safetensors serialization + LRU) |
...
| **Yunshu** | **~17,000 行** | **中高（API 廣度最大 + SSD tier + mRoPE + preemption）** |
