...
class JACCLBenchmark:
    ...
    def bench_all_reduce(self, size: int, group: Optional[object] = None) -> dict:
    ...
    def bench_all_gather(self, size: int, group: Optional[object] = None) -> dict:
    ...
    def bench_send_recv(self, size: int, group: Optional[object] = None) -> dict:
    ...
    def bench_ring_bandwidth(self, group: Optional[object] = None) -> dict:
    ...
    def run(self, group: Optional[object] = None) -> list[dict]:
