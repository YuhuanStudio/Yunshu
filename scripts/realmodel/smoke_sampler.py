"""real-model smoke: confirm the default fast-path sampler with
...
Run isolated: PYTHONPATH=. uv run python scripts/realmodel/smoke_sampler.py
"""
import asyncio
...
async def main():
    ...
    # Combined top_k + top_p + temp (the precise trigger).
    ...
    await eng.stop()
    print("\nW721/real-model sampler smoke: PASS")
