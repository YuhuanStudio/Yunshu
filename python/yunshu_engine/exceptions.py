...
class OutOfMemoryError(MemoryError):
    def __init__(self, message: str, requested_bytes: int | None = None, available_bytes: int | None = None):
        super().__init__(message)
        self.requested_bytes = requested_bytes
        self.available_bytes = available_bytes

class PrefillMemoryExceededError(MemoryError):
    def __init__(self, message: str, request_id: str | None = None, estimated_bytes: int | None = None, limit_bytes: int | None = None):
        super().__init__(message)
        self.request_id = request_id
