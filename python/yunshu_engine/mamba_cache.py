...
Some models mix attention types in the same model (full attention, sliding
window, MLA, Mamba SSM states), while Yunshu currently only supports a single
attention type. Hybrid models like Jamba, Zamba, and others
