...
"""Forward batch representation — multi-level batch hierarchy.

A 3-level batch hierarchy optimized for Apple Silicon + MLX:
...
class ScheduleBatch:
    ...
    def split_prefill_decode(self) -> tuple[ScheduleBatch, ScheduleBatch]:
        """Split into prefill batch and decode batch.
...
class BatchComposer:
    """Composes schedule batches from pending requests.
