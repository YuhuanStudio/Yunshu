...
class SpecPrefillEngine:
    ...
    def try_prefill(self, available_budget: int) -> Optional[PrefillEntry]:
    ...
    def get_entry(self, request_id: str) -> Optional[PrefillEntry]:
        """Retrieve a prefill entry by request ID."""
        return self._entries.get(request_id)

    def remove_entry(self, request_id: str) -> Optional[PrefillEntry]:
    ...
    def peek_next(self) -> Optional[PrefillEntry]:
    ...
    @property
    def current(self) -> Optional[PrefillEntry]:
    ...
    def _pick_next_pending(self) -> Optional[PrefillEntry]:
