...
class InferenceWorker:
    ...
    def __init__(
        ...
        self._request_pipe: tuple | None = None
        self._result_pipe: tuple | None = None
        self._heartbeat_pipe: tuple | None = None
    ...
    def is_healthy(self) -> bool:
        ...
        return not (self._process is not None and not self._process.is_alive())
...
class WorkerSupervisor:
    ...
    def get_healthy_worker(self, model_id: str) -> InferenceWorker | None:
