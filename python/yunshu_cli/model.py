...
def _detect_model_type(config_path: Path) -> str:
    """Auto-detect model type from config.json (oMLX pattern)."""
...
def list_models(
    models_dir: Optional[str] = typer.Option(None, "--dir", "-d", help="Models directory."),
...
def download_model(
    ...
    models_dir: Optional[str] = typer.Option(None, "--dir", "-d", help="Download directory."),
